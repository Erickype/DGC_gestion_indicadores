<script lang="ts">
	...
	import { addSocialProjectListSchema, type AddSocialProjectListSchema } from './schema';
	...
	export let data: SuperValidated<Infer<AddSocialProjectListSchema>, App.Superforms.Message>;
	...
	const form = superForm(data, {
		validators: zodClient(addSocialProjectListSchema),
		taintedMessage: null,
		onUpdated: ({ form: f }) => {
