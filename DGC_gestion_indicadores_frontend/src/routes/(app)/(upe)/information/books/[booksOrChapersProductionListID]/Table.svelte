<script lang="ts">
	...
	import type { UpdateBooksOrChaptersProductionListsAuthorCareersSchema } from './schema';
	...
	export let authorsCareers: BooksOrChaptersProductionListsAuthorsCareersJoined[];
	export let formData: SuperValidated<
		Infer<UpdateBooksOrChaptersProductionListsAuthorCareersSchema>,
		App.Superforms.Message
	>;
	let authorCareer: BooksOrChaptersProductionListsAuthorsCareersJoined;
