<script lang="ts">
	...
	import {
		addBookOrChaptersProductionListSchema,
		type AddBookOrChaptersProductionListSchema
	} from './schema';
	...
	export let data: SuperValidated<
		Infer<AddBookOrChaptersProductionListSchema>,
	...
	const form = superForm(data, {
		validators: zodClient(addBookOrChaptersProductionListSchema),
		taintedMessage: null,
		onUpdated: ({ form: f }) => {
