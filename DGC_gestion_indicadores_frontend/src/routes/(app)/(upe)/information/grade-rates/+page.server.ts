...
import { PostGradeRateList, UpdateGradeRateList } from "$lib/api/controller/api/indicatorsInformation/gradeRateLists";
...
export const actions: Actions = {
    ...
    updateGradeRateList: async (event) => {
        const form = await superValidate(event, zod(updateGradeRateListSchema))
        ...
        const response = await UpdateGradeRateList(token!, gradeRateList)
