<script lang="ts">
	...
	import { addAuthorSchema, type AddAuthorSchema } from './schema';
	...
	export let data: SuperValidated<Infer<AddAuthorSchema>, App.Superforms.Message>;
	...
	const form = superForm(data, {
		...
		onUpdated: ({ form: f }) => {
			...
			if (message.success) {
				const _ = message.data as Teacher;
				TeacherCreated();
...
<form action="?/addAuthor" use:enhance>
